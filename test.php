...
function buildMakumiElfu($number)
{
    ...
    {
        return $makumiElfu . "" .   $mamia; // . " " . $makumi . "" . $mamoja; 
...
function mamilioni($number)
{
    ...
    if ($length == 1) {
        switch ($number) {
            case 1:
                $announce = "Milioni_moja";
                break;
            case 2:
                $announce = "Milioni_mbili";
                break;
            case 3:
                $announce = "Milioni_tatu";
                break;
            case 4:
                $announce = "Milioni_nne";
                break;
            case 5:
                $announce = "Milioni_tano";
                break;
            case 6:
                $announce = "Milioni_sita";
                break;
            case 7:
                $announce = "Milioni_saba";
                break;
            case 8:
                $announce = "Milioni_nane";
                break;
            case 9:
                $announce = "Milioni_tisa";
                break;
        }
    } else if ($length == 2) {
...
function makumiElfuDouble($number)
{
    ...
    switch ($makumiElfu) {
        case 1:
            // $announce = ($maelfu > 0) ?  "elfu_kumi" . " na " . mamoja($maelfu) : "elfu_kumi";
            if($maelfu > 0) {
                $announce2 = " na_" . mamoja($maelfu);
                $announce1 = "elfu_kumi";
            }
            else {
                $announce1 = "elfu_kumi";
            ...
            break;
        case 2:
            $announce = $maelfu > 0 ?  "elfu_ishirini" . " na " . mamoja($maelfu) : "elfu_ishirini";
            break;
        case 3:
            $announce = $maelfu > 0 ?  "elfu_thelathini" . " na " . mamoja($maelfu) : "elfu_thelathini";
            break;
        case 4:
            $announce = $maelfu > 0 ?  "elfu_arobaini" . " na " . mamoja($maelfu) : "elfu_arobaini";
            break;
        case 5:
            $announce = $maelfu > 0 ?  "elfu_hamsini" . " na " . mamoja($maelfu) : "elfu_hamsini";
            break;
        case 6:
            $announce = $maelfu > 0 ?  "elfu_sitini" . " na " . mamoja($maelfu) : "elfu_sitini";
            break;
        case 7:
            $announce = $maelfu > 0 ?  "elfu_sabini" . " na " . mamoja($maelfu) : "elfu_sabini";
            break;
        case 8:
            $announce = $maelfu > 0 ?  "elfu_themanini" . " na " . mamoja($maelfu) : "elfu_themanini";
            break;
        case 9:
            $announce = $maelfu > 0 ?  "elfu_tisini" . " na " . mamoja($maelfu) : "elfu_tisini";
            break;
    }
    $announce = strtoupper($announce1) . ".mp3+" . strtoupper($announce2). ".mp3+" ;
    return ($announce);
}
